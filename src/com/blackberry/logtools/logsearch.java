...
public class logsearch extends Configured implements Tool {
	...
	public static void main(String[] argv) throws Exception {
		...
		int res = ToolRunner.run(new Configuration(), new logsearch(), argv);
		System.exit(res);
	}  
	...
	public int run(String[] argv) throws Exception {	
		...
		LogTools.logConsole(quiet, silent, warn, "Passing Arguments: SearchString=" + args[stringNum] + " DC=" + args[dcNum] + " Service=" + args[svcNum]
		...
		//Start Mapreduce job
		tools.runMRJob(quiet, silent, conf, D_options, out, LOG, field_separator, queue_name, args, "FastSearchByTime", new FastSearchByTime());
