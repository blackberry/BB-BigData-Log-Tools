...
/** Return data for services contained in the latest index in /service/.index
 *  <p>
...
public class QueryIndex {
  ...
  private static void readJSONIntoMap(Map<String, Map<String, Map<String, Map<String, Component>>>> data, String JSONString) throws JSONException {
  ...
  private static Set<String> listDCs(Map<String, Map<String, Map<String, Map<String, Component>>>> data, String searchString) {
  ...
  private static Set<String> listServices(Map<String, Map<String, Map<String, Map<String, Component>>>> data, String DC, String searchString) {
  ...
  private static Set<String> listTypes(Map<String, Map<String, Map<String, Map<String, Component>>>> data, String DC, String service, String searchString) {
  ...
  private static Set<String> listComponents(Map<String, Map<String, Map<String, Map<String, Component>>>> data, String DC, String service, String type, String searchString) {
  ...
  private static Set<Component> matchedComponents(Map<String, Map<String, Map<String, Map<String, Component>>>> data, String DCString, String serviceString, String typeString, String componentString, Date startDate, Date endDate) {
      ...
      for (String service : listServices(data, DC, serviceString)) {
        for (String type : listTypes(data, DC, service, typeString)) {
          for (String component : listComponents(data, DC, service, type, componentString)) {
            ...
            if(new Date(matchedComponent.endDate.getTime() + oneDay).after(startDate) && matchedComponent.startDate.before(endDate)) {
  ...
  private static double getIngestRate(Component component) {
    double ingestTime;
  ...
  private static Date getEarliestDate(Set<Component> components) {
  ...
  private static Date getLatestDate(Set<Component> components) {
  ...
  private static double totalSize(Set<Component> components) {
  ...
  private static void printComponents(FileSystem fs, Set<Component> components, boolean showDates, boolean showSize, boolean showIngest, boolean greppable, Date startDate, Date endDate, boolean printIngestOverTime) throws IOException, ParseException {
